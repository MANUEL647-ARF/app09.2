...
def main(page: ft.Page):
    ...
    btn38 =  ElevatedButton(content=ft.Image(src="tiktok.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="tik tok"))
    
    btn39 =  ElevatedButton(content=ft.Image(src="telegram.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="telegram"))
    btn40 = ElevatedButton(content=ft.Image(src="pinte.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="pinte"))
    btn41 = ElevatedButton(content=ft.Image(src="grindr.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="grindr"))
    btn42 = ElevatedButton(content=ft.Image(src="link.png",width=img_width,height=img_height,border_radius=border_radius,semantics_label="linked"))
